        ...
        return (
            <div >
                ...
                >
                    ...
                    >
                        <h1 style={{ color: "#fac8c3", fontSize: "30px", marginLeft: "-5%" }}>Secant Method</h1>
                        ...
                        <h2 style={{ marginLeft: "65%" }} >X<sub>1</sub></h2><Input size="large" name="x1" style={InputStyle}></Input>
                        <br /><br />
