        ...
        <nav className="nav">
          <ul>
            ...
            <div class="dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby=" dropdownMenuButton2 " >
                <li><a class="dropdown-item " href="/Cholesky">Cholesky</a></li>
                <li><a class="dropdown-item " href="/Conjugate_Gradient">Conjugate_Gradient</a></li>
                <li><a class="dropdown-item " href="/Cramer">Cramer</a></li>
                <li><a class="dropdown-item " href="/Gauss_Jordan_Method">Gauss_Jordan_Method</a></li>
                <li><a class="dropdown-item " href="/Gauss_seidel">Gauss_seidel</a></li>
                <li><a class="dropdown-item " href="/Jacobi">Jacobi</a></li>
                <li><a class="dropdown-item " href="/Lu">Lu</a></li>
              </ul>
              ...
              <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby=" dropdownMenuButton2 " >
                <li><a class="dropdown-item " href="/Composite_Simpson_Rul">Composite_Simpson_Rule</a></li>
                <li><a class="dropdown-item " href="/Composite_Trapezoidal_Rule">Composite_Trapezoidal_Rule</a></li>
                <li><a class="dropdown-item " href="/Simpson">Simpson</a></li>
                <li><a class="dropdown-item " href="/Trapzoidal">Trapzoidal</a></li>
              </ul>
            </div>
          </ul>
        </nav>
